...
class FormHelper
{
     ...
     * @param boolean $boolValueAsKey invert test with value as key (useful when use of sub-table)
     *
     * @return boolean
     */
    public static function isSelected($strVariableName, $strValue, $boolValueAsKey = false)
    {
        ...
        if (is_array(static::$hashData[$strVariableName])) {
            if ($boolValueAsKey) {
                return isset(static::$hashData[$strVariableName][$strValue]);
            }
     ...
     * @return string
     */
    public static function getSelected($strVariableName, $strValue, $boolValueAsKey = false)
    {
        if (static::isSelected($strVariableName, $strValue, $boolValueAsKey)) {
     ...
     * @return string
     */
    public static function getChecked($strVariableName, $strValue, $boolValueAsKey = false)
    {
        if (static::isSelected($strVariableName, $strValue, $boolValueAsKey)) {
